...
const Profile=()=>{
    ...
    const { email,mobile_number,about,location,address } = state;
    useEffect(()=>{
                ...
                {(props) => (
                   ...
                   <Grid container spacing={2}>
                        ...
                        <Grid item xs={6}>
                            ...
                            <input type="radio" label="Male"checked={gender==="Male"} value="Male" onClick={()=>setGender("Male")} 
                            onChange={(e) =>
                              dispatch({
                                type: 'field',
                                fieldName: 'gender',
